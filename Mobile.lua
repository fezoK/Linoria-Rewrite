if game:GetService("CoreGui"):FindFirstChild("Martian") then
    game:GetService("CoreGui"):FindFirstChild("Martian"):Destroy()
end
...
ToggleButton.MouseButton1Click:Connect(function()
	game.CoreGui:FindFirstChild("Martian").Enabled = not game.CoreGui:FindFirstChild("Martian").Enabled
end)
...
local Library = {
    ...
    AccentColor = Color3.fromRGB(113, 197, 98);
